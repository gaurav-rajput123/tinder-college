                ...
                <View style={styles.itemContainer}>
                    ...
                    <View style={[styles.flipQuestions]} ref={flipRef}>
                        <View style={styles.questionBox}>
                            <Text style={styles.questionLabel}>My College Is</Text>
                            <TextInput maxLength={15} mode='flat' underlineColor="pink" value={college} onChangeText={(value)=>setCollege(value)} style={[styles.input]} theme={{ colors: { primary: 'pink',underlineColor:'transparent',}}}/>
                        </View>
                    </View>
