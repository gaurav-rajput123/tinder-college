...
const Branch = ({navigation}) => {
    ...
    const handleSubmit = () => {
        navigation.navigate("usercollege")
                ...
                <View style={styles.itemContainer}>
                    ...
                    <View style={[styles.flipQuestions]} ref={flipRef}>
                        <View style={styles.questionBox}>
                            <Text style={styles.questionLabel}>My Branch Is</Text>
                            <TextInput maxLength={15} mode='flat' underlineColor="pink" value={branch} onChangeText={(value)=>setBranch(value)} style={[styles.input]} theme={{ colors: { primary: 'pink',underlineColor:'transparent',}}}/>
                        </View>
                    </View>
